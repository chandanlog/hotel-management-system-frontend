  ...
  return (
    <div className="container animate-fade-in">
      ...
      <div className="card" style={{padding:0, overflow:'hidden', border:'none', boxShadow:'0 20px 40px -10px rgba(0,0,0,0.5)'}}>
        <div style={{height:'50vh', background:'#0f172a', position:'relative'}}>
             {images.length > 0 && (
                <img 
             ...
             <div style={{
                 ...
                 <div>
                    ...
                    <h1 style={{fontSize:'3.5rem', margin:0, lineHeight:1, textShadow: '0 4px 10px rgba(0,0,0,0.5)', color: 'white'}}>{room.room_name}</h1>
                 </div>
        ...
        <div style={{padding:'3rem', background: 'var(--bg-card)'}}>
